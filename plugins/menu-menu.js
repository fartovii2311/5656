...
*˚₊·˚₊· ͟͟͞͞➳❥* ${packname}${conn.user.jid == global.conn.user.jid ? '' : `\n*˚₊·˚₊· ͟͟͞͞➳❥* Эльза⇢ *@${global.conn.user.jid.split`@`[0]}*`}
*☆═━┈◈ ╰ ${vs} ㎇ ╯ ◈┈━═☆*
*│* 
*╰ ㊂ ▸▸ _${lenguajeGB.smsMenuTotal1()}_ ◂◂*
*╰ ㊂ ▸▸☆═━┈◈ ╰ Команды Создателя ╯ ◈┈━═☆*
*│* ┊▸ ✦ _*включить ограничить*_
*│* ┊▸ ✦ _*выключить ограничить*_
*│* ┊▸ ✦ _*включить авточтение*_
*│* ┊▸ ✦ _*выключить авточтение*_
*│* ┊▸ ✦ _*включить антивызов*_
*│* ┊▸ ✦ _*выключить антивызов*_
*│* ┊▸ ✦ _*аренда*_
*│* ┊▸ ✦ _*чекаренды*_
*│* ┊▸ ✦ _*сбросаренды*_
*╰ ㊂ ▸▸☆═━┈◈ ╰ Команды Админов ╯ ◈┈━═☆*

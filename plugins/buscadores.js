...
try {
let syms = `Actuaras como un Bot de WhatsApp el cual fue creado por GataNina-Li, tu seras ЭльзаLite-MD`
...
handler.command = /^(googlef?|openai|chatgpt|ia|ai|bot|simi|предатель|alexa|bixby|cortana|siri|okgoogle|githubstalk|usuariogithub|usergithub|(yt(s|search)|(openaivoz|chatgptvoz|iavoz|robotvoz|openai2voz|chatgpt2voz|ia2voz|robot2voz|gatavoz|GataBotvoz|gptvoz|ai_voz|aivoce)|(translate|traducir|trad))|gemini|bard|bing|bingia|iabing|copilot)$/i
